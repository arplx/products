...
fetch('products.json')
  ...
  .then(products => {
    products.forEach(product => {
      ...
      <a <button="" href="${product.url}" type="button" style="height: 45px;padding: 0px;background-color: #000;width: 300px;border-radius: 10px;border: 1px solid #2928e6;">
  <img alt="Image description" style="height: 45px;padding-left: 85px;padding: 2;margin-left: 85px;" src="https://i.postimg.cc/SRwHB50H/Screenshot-2023-12-25-at-15-57-13-Aria-1.png">
</a>
      `;
